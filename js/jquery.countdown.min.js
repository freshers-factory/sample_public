!function(t){
    t.fn.countdown=function(e,n){
      function o(){
        ...
        // Start with 1 day (86400 seconds in milliseconds)
        if (o >= 86400 * 1000) {
          o = 86400 * 1000; // Set to 1 day in milliseconds
        }
        ...
        var a = 1e3, f = 60 * a, u = 60 * f, l = 24 * u,
            c = Math.floor(o / l),
            h = Math.floor(o % l / u),
            x = Math.floor(o % u / f),
            g = Math.floor(o % f / a),
      ...
      if (!r.date) t.error("Date is not defined.");
      if (!Date.parse(r.date)) t.error("Incorrect date format, it should look like this, 12/24/2012 12:00:00.");
